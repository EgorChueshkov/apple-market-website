...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0007_auto_20201119_0816'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buying_type', models.CharField(choices=[('self', 'Самовывоз'), ('delivery', 'Доставка')], default='self', max_length=100, verbose_name='Тип заказ')),
